...
# = COMPILE SECTION
# =============================================================================
build: build-scala-2.11 build-scala-2.12
...
it-test-all: it-test-scala-2.11 it-test-scala-2.12
...
# = ASSEMBLY SECTION
# =============================================================================
assembly: assembly-scala-2.11 assembly-scala-2.12
